    ...
    <Container maxW="container.xl">
      {isLoading ? (
        ...
        <>
         ...
         <Container  mt="20px">
          <Text display="flex" justifyContent="center" fontSize={25}>Here to help keep you on the move</Text>
          <Flex>
          <Box  border="1px" borderColor="black.200" borderRadius="10px" w="5000px" mt='20px' ml="50px" p='6'  h="320px" rounded='md' bg='white'>
            <Text fontWeight="bold">Change or cancel a trip</Text>
            <Text>Make updates to your itinerary or cancel a booking</Text></Box>
          <Box border="1px" borderColor="black.200" borderRadius="10px"  w="5000px" mt='20px' ml ="50px"  h="320px" rounded='md' bg='white'><Text fontWeight="bold">Use a credit or coupon</Text>
          <Text>Apply a coupon code or credit to a new trip</Text></Box>
          <Box  border="1px" borderColor="black.200" borderRadius="10px"  mt='20px' ml="50px" p='6' w="5000px" h="320px" rounded='md' bg='white'>
            <Text fontWeight="bold">Track your refund</Text>
            <Text>Check the status of  a refund currently in progress</Text></Box>
          </Flex>
